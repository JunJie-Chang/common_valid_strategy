...
系統支援多個技術指標組合的策略，以提高訊號的可靠性：

- **RSI_MACD**: RSI超賣且MACD金叉時買入
- **RSI_STOCHASTIC**: RSI和KD都顯示超賣時買入
- **MACD_MA**: MACD金叉且價格在MA20上方時買入
- **RSI_BOLLINGER**: RSI超賣且觸及布林下軌時買入
- **MACD_STOCHASTIC**: MACD金叉且KD超賣時買入
- **MA_BOLLINGER**: 價格在MA20上方且觸及布林下軌時買入
- **RSI_MACD_MA**: RSI、MACD和移動平均線三重組合策略
- **MACD_MA_CROSS**: MACD金叉且5日線上穿20日線時買入
